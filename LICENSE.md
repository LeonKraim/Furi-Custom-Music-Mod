...
- "Derivative work" means anything you make with or from the Software or a Pack.
- "Source" means everything needed to build the distributed files.
  This includes source code, scripts, manifests, and original assets.
- "Revenue" means money you receive from a Derivative work.
  This includes sales, fees, subscriptions, and royalties.
...
- You must publish the Source of the Derivative work.
- You must publish it in a public place, for example a public repository.
- You must publish it under an approved open-source license, for example
  MIT or GPL-3.0.
- You must publish it where you distribute the Derivative work.
...
- You must pay the Author within thirty (30) days after the end of each
  calendar quarter.
- You must send a written report with each payment.
  The report shows the sales and the payment amounts.
